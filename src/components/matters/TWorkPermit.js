...
class TWorkPermit extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>1、身份证原件<br/>2、近期一寸免冠照片（一张）；<br/>3、换发的须上交原有工作证</td>
                  </tr>
                  <tr>
                    <td className={styles.tdTitle}>办理流程</td>
                    <td>1、办理新证和丢失补办<br/>
教职工携带身份证到阳光服务大厅人事处窗口直接办理<br/>
2、换发<br/>
教职工携带身份证和原工作证到阳光服务大厅人事处窗口直接办理</td>
                  </tr>
                </tbody>
              </table>
            </div>
