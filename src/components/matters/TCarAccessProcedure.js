...
class TCarAccessProcedure extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>本人工作证、驾驶证、车辆行驶证</td>
                  </tr>
                  <tr>
                    <td className={styles.tdTitle}>办理流程</td>
                    <td>本人登录山西财经大学网上办事大厅→选择教职工新注册机动车辆门禁系统手续办理事项→下载并填写《山西财经大学机动
                    车辆门禁系统注册申请表》→本人携带相关证件和材料直接在阳光服务大厅保卫处窗口办理。</td>
                  </tr>
                  <tr>
...
export default TCarAccessProcedure;
