...
class SCarAccessProcedure extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  <tr>
                    ...
                    <td>研究生新注册机动车辆门禁系统手续办理</td>
                  </tr>
                  <tr>
                    <td className={styles.tdTitle}>服务对象</td>
                    <td>未在学校安排住宿的在册研究生</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>学生证、 本人驾驶证、车辆行驶证</td>
                  </tr>
                  <tr>
                    <td className={styles.tdTitle}>办理流程</td>
                    <td>本人登录山西财经大学网上办事大厅→选择研究生新注册机动车辆门禁系统手续办理事项→下载并填写《山西财经大学机动车辆门禁系统注册申请表》→本人携带相关材料在阳光服务大厅大学生教育服务中心窗口审核在校住宿情况→到阳光服务大厅保卫处窗口办理。</td>
                  </tr>
                  <tr>
...
export default SCarAccessProcedure;
