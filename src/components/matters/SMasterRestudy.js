...
class SMasterRestudy extends React.Component {
  constructor(props) {
  ...
  onSubmit = (data) => {
    ...
    this.props.dispatch(
      { type: 'matterSMasterRestudy/uploadTable', payload: data }
    )
  }
  // 判断是否登录
  isLogin = (key) => {
                ...
                <table className={styles.serviceTable}>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>《山西财经大学学术学位硕士研究生培养管理办法》<br/>
《山西财经大学专业学位硕士研究生培养管理办法》</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td>学生登录山西财经大学网上办事大厅→选择硕士研究生课程重修、重考手续办理事项→填写《山西财经大学硕士研究生课程重修、重考申请表》→提交学生所在学院分管副院长签字→提交研究生学院学籍管理科审核成绩并签字→提交研究生学院教学运行科安排执行→学生携带学生证原件在阳光服务大厅研究生学院窗口领取办理结果→学生将办理结果反馈至所在学院和任课教师</td>
                    </tr>
                    <tr>
          ...
          <table className={styles.table}>
            <tbody>
              <tr>
                ...
                <td className={styles.tdTitle}>所在学院</td>
                <td >
                <FormItem>
                    {getFieldDecorator('faculty', {
                      rules: [{ required: true, message: '请输入您所在学院' }],
                    })(
                      <Input placeholder="请输入您所在学院" />
                      )}
                  </FormItem>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td colSpan='6' className={styles.signatureTd}>
                <div className={styles.signature}>分管副院长签字：<br/>&emsp;&emsp;年&emsp;  月&emsp;  日</div><br/>
              </td>
              </tr>
              <tr>
                <td className={styles.tdTitle}>成绩审核：</td>
                <td colSpan='6' className={styles.signatureTd}>
                <div className={styles.signature}>签&emsp;&emsp;&emsp;字：<br/>年&emsp;  月&emsp;  日</div><br/>
              </td>
              </tr>
            </tbody>
          </table>
...
function mapStateToProps({ matterSMasterRestudy, login }) {
  return { matterSMasterRestudy, login };


}
;
export default connect(mapStateToProps)(SMasterRestudy);
