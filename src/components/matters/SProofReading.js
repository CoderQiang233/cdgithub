...
class SProofReading extends React.Component{
  constructor(props){
      ...
      <Tabs defaultActiveKey="1" type='card'>
          <TabPane tab={<span><Icon type="compass" />办事指南</span>} key="1">
            <div className={styles.serviceBox}>
              <h1 className={styles.title}>教务处阳光服务卡</h1>
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>学生携带本人学生证、身份证在阳光服务大厅教务处窗口直接办理（代办需要提供双方学生证原件）</td>
                  </tr>
                  <tr>
