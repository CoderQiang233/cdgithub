...
class TProofIncome extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>身份证、工作证、相关机构提供的纸质版格式</td>
                  </tr>
                  <tr>
                    <td className={styles.tdTitle}>办理流程</td>
                    <td>教职工携带身份证和相关机构提供的纸质版格式直接在阳光服务大厅人事处窗口办理</td>
                  </tr>
                  <tr>
