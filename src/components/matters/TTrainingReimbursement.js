...
class TTrainingReimbursement extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>工作证、进修单位结业证书（高访学者）、报销单据</td>
                  </tr>
                  <tr>
                    <td className={styles.tdTitle}>办理流程</td>
                    <td>教职工携带工作证和相关报销材料原件在阳光服务大厅人事处窗口直接办理</td>
                  </tr>
                  <tr>
...
export default TTrainingReimbursement;
