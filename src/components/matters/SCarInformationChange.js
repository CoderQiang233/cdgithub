...
class SCarInformationChange extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>本人登录山西财经大学网上办事大厅→选择已注册机动车辆门禁系统信息变更手续办理事项→填写《山西财经大学机动车辆信息变更登记表》并上传变更后的车辆行驶证电子照片→阳光服务大厅保卫处窗口于后台统一办理。</td>
                  </tr>
                  <tr>
...
export default SCarInformationChange;
