...
class SMasterDelayed extends React.Component {
  constructor(props) {
...
onSubmit = (data) => {
  ...
  data.matterKey=this.props.matterKey;
    ...
    this.props.dispatch(
     { type: 'matterSMasterDelayed/uploadTable', payload: data }
    )
}
                ...
                <table className={styles.serviceTable}>
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>学生登录山西财经大学网上办事大厅→选择硕士研究生课程缓考事项→填写《山西财经大学硕士研究生课程缓考申请表》并上传相关证明材料电子照片→提交任课教师审批→提交学生所在学院分管副院长签字→提交研究生学院分管教学副院长签字→提交研究生学院教学运行科安排执行→学生携带学生证、相关证明材料原件在阳光服务大厅研究生学院窗口领取办理结果→学生将办理结果反馈至学生所在学院和任课教师</td>
                    </tr>
                    <tr>
...
;
export default connect(mapStateToProps)(SMasterDelayed);