...
class TCAccountCopy extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>教职工（子女）本人携带身份证原件在阳光服务大厅保卫处窗口办理。如本人不能亲自办理，需提供委托书及双方身份证原件。</td>
                  </tr>
                  <tr>
