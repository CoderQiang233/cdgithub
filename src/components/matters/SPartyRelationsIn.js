...
class SPartyRelationsIn extends React.Component{
  constructor(props){
              ...
              <table className={styles.serviceTable}>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>学生党员持县级以上具有直接转接权限党委组织部门开具的组织关系介绍信和党员档案到阳光服务大厅党委组织部窗口办理→组织部审核无误后开具盖有党委组织部公章的《中国共产党党员组织关系介绍信》→本人持校党委组织部介绍信和档案到所在基层党委报到。</td>
                  </tr>
                  <tr>
...
export default SPartyRelationsIn;
